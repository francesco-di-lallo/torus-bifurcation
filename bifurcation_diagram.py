...
def bifurcation_diagram(PC):
    ...
    PC['SNE1'].display(coords = ['ox','oy'], linewidth = 0.2, c='b')
    
    PC['SNE2'].display(coords = ['ox','oy'], linewidth = 0.2, c='b')
    
    PC['TR01'].display(coords = ['ox','oy'], linewidth = 0.2, c='k')
    
    PC['TR02'].display(coords = ['ox','oy'], linewidth = 0.2, c='k')
    ...
    plt.plot(rhc_ox, rhc_oy, linewidth = 0.2, c='r')
    plt.plot(rhc_ox_lift, rhc_oy_lift, linewidth = 0.2, c='r')
    ...
    plt.plot(bottom_rhc_ox, bottom_rhc_oy, linewidth = 0.2, c='r')
    plt.plot(bottom_rhc_ox_lift, bottom_rhc_oy_lift, linewidth = 0.2, c='r')
...
PC['TR01'].computeEigen()
PC['TR01'].display(coords = ['ox','oy'], stability=True)
"""